...
enum {
	POWER_SUPPLY_PTP_INT_SND_NEVER = 0,
	POWER_SUPPLY_PTP_INT_SND_SUPPLEMENTAL,
	POWER_SUPPLY_PTP_INT_SND_LOW_BATT_SAVER,
	POWER_SUPPLY_PTP_INT_SND_UNKNOWN,
};

enum {
	POWER_SUPPLY_PTP_INT_RCV_NEVER = 0,
	POWER_SUPPLY_PTP_INT_RCV_FIRST,
	POWER_SUPPLY_PTP_INT_RCV_SECOND,
	POWER_SUPPLY_PTP_INT_RCV_PARALLEL,
	POWER_SUPPLY_PTP_INT_RCV_UNKNOWN,
};

enum {
	POWER_SUPPLY_PTP_EXT_NOT_SUPPORTED = 0,
	POWER_SUPPLY_PTP_EXT_SUPPORTED,
	POWER_SUPPLY_PTP_EXT_SUPPORT_UNKNOWN,
};
...
enum {
	POWER_SUPPLY_PTP_EXT_NOT_PRESENT = 0,
	POWER_SUPPLY_PTP_EXT_PRESENT,
	POWER_SUPPLY_PTP_EXT_PRESENCE_UNKNOWN,
};
